...
import imageUrl from '/image3.jpg'; // Correctly import the image
    ...
    <div className={`about-container ${isAnimating ? "page-enter" : ""}`}>
      ...
      <div className="image-container">
        ...
        <div className="overlay1">
          ...
          <p2 className="custom-paragraph">“Achieve Your Fitness Goals with Smart Tracking & Personalized Plans.”</p2>
